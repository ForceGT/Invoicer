...
class _NewTermState extends State<NewTerm> {
  ...
  void initState() {
    super.initState();
    this.isChecked = widget._isEdit == true
        ? (widget._term!.type == "default" ? true : false)
        : false;
    this._termController = widget._isEdit == true
        ? TextEditingController(text: widget._term!.terms)
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (widget._isEdit == false) {
                          TandC tandC =
                              TandC(terms: _termController.text, type: type);
...
//   properties.add(DiagnosticsProperty<TextEditingController>('_termController', _termController));
// }
